...
│   └── bill_extraction.py   # Vision-based bill photo parsing (Groq API)
├── tests/
...
The bill-photo feature needs a Groq API key (get one free at [console.groq.com](https://console.groq.com)):
...
3. Add `GROQ_API_KEY` under the Space's **Settings → Repository secrets**.
